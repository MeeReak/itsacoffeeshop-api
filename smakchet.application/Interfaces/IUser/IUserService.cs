...
namespace smakchet.application.Interfaces.IUser
{
    public interface IUserService
    {
        ...
        public Task<UserReadDto?> UpdateUserAsync(int userId, UserUpdateDto userDto, CancellationToken cancellationToken);
        public Task<UserReadDto> CreateUserAsync(UserDto userDto, CancellationToken cancellationToken);

...
namespace smakchet.api.Controllers.V2026_01_01
{
    ...
    [ApiController]
    public class SugarController(ISugarService service) : ControllerBase
    {
        [HttpGet]
        [ProducesResponseType(typeof(ResponsePagingDto<SugarReadDto>), StatusCodes.Status200OK)]
        ...
        [HttpGet("{id:int}")]
        [ProducesResponseType(typeof(SugarReadDto), StatusCodes.Status200OK)]
